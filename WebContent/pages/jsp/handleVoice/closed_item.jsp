...
<div id="notification" style="margin: 5px 5px 10px 50px;">
	<s:if test="voices.size() != 0">
		<span class="label label-important">
			You have <s:property value="resolvedSize"/> closed voices need to process 
		 </span>
	</s:if>
</div>
...
<div id="modal_<s:property value='voice.voiceId'/>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">Reopen Voice</h3>
	<small><s:property value="voice.title"/></small>  
  </div>
  <div class="modal-body">
    <form action="<%=basePath%>/admin/reOpenVoice" method="post" id="subForm_<s:property value="voice.voiceId"/>">
          <p><small>Please write down the reason for reopening the Voice.</small></p>
          <div class="input">
  ...
  <div class="modal-footer">
	...
	<a data-target="#modal_<s:property value='voice.voiceId'/>" role="button" class="btn" data-toggle="modal">Reopen</a>
				</td>
			</tr>
		</s:iterator>
	</table>
